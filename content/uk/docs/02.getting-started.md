...
## ШІ-допомога {#ai-assistance}

Отримайте розумну допомогу у IDE з підтримкою ШІ під час роботи з Rete.js. Використовуйте агента або функцію виконання команд вашого IDE (доступно в Cursor, GitHub Copilot Chat та подібних інструментах) і просто запитайте свого ШІ-асистента:

```prompt
Запусти npx rete-kit@latest ai
```

Запустіть один раз на проєкт — це запускає коротке налаштування Rete.js ШІ через агента. Далі запитуйте про вивчення, створення, розширення Rete.js.

Для отримання детальної інформації див. документацію [ШІ-асистент](/uk/docs/development/ai-assistance).
