# React.js рендер
::alert
Цей гайд є розширенням гайду [Базовий редактор](../basic) і містить детальні інструкції щодо використання `rete-react-render-plugin`
::
...
Перегляньте сторінку [Базовий редактор](/examples), щоб отримати приклад використання цього плагіна рендерінгу.
...
Це спрощена версія, яка підходить для ознайомлення. Для проектів рекомендується дотримуватися підходу, продемонстрованого в [прикладі](/examples/react/controls)
...
Реалізація `CustomNode` доступна у файлі **CustomNode.tsx** прикладу [Кастомізація для React.js](/examples/react/customization).
...
Перегляньте повний результат на сторінці прикладу [Налаштування для React.js](/examples/react/customization).
