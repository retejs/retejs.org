# React.js рендер
::alert
Цей гайд є розширенням гайду [Базовий](../basic) і містить детальні інструкції щодо використання `rete-react-render-plugin`
::
...
Перегляньте сторінку [Базовий](/examples), щоб отримати приклад використання цього плагіна рендерінгу.
