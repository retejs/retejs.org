...
### Події пакету `rete` {#rete-package-events-v1}
- nodecreate *
- nodecreated *
- noderemove *
- noderemoved *
...
### Події пакету `rete-connection-plugin` {#rete-connection-plugin-package-events-v1}
...
### Події пакету `rete` {#rete-package-events-v2}
...
### Події пакету `rete-area-plugin` {#rete-area-plugin-package-events}
...
### Події пакету `rete-connection-plugin` {#rete-connection-plugin-package-events-v2}

- connectionpick
- connectiondrop

### Події пакету `rete-angular-plugin` {#rete-angular-plugin-package-events}

- connectionpath

### Події пакету `rete-vue-plugin` {#rete-vue-plugin-package-events}

- connectionpath

### Події пакету `rete-react-plugin` {#rete-react-plugin-package-events}
