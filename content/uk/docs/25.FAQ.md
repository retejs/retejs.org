...
::questions
  ...
  ::
  ::qa{question="Як обробляти події подвійного натискання на вузлах?" id="handle-dblclick"}
    Створіть кастомний компонент вузла з обробником події `dblclick`.

    Перегляньте відповідний гайд по кастомізації для вашого рендереру: [React.js](/uk/docs/guides/renderers/react#customization), [Vue.js](/uk/docs/guides/renderers/vue#customization), [Angular](/uk/docs/guides/renderers/angular#customization), [Svelte](/uk/docs/guides/renderers/svelte#customization) або [Lit](/uk/docs/guides/renderers/lit#customization).

    **Важливо:** Якщо ваш кастомний вузол містить вкладені інтерактивні елементи (кнопки, інпути тощо), переконайтеся, що ви запобігаєте поширенню подій, щоб уникнути конфліктів з обробником подвійного натискання вузла.
  ::
