...
::alert{type="warning"}
**Вимога React 19**: При використанні React 19 передача `createRoot` як параметра є **обов'язковою** при ініціалізації ReactPlugin. Це потрібно через зміни в системі рендерингу React 19.
::
...
У випадку, якщо ви використовуєте React.js версії 16 або 17, метод `createRoot` є необов'язковим
