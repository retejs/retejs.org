...
Якщо ваш додаток дозволяє вибирати вузли, користувачі можуть захотіти переглядати вибрані вузли без будь-яких візуальних перешкод. Для цього доступні додаткові розширення, які автоматично виводять вибраний вузол на передній план.

```ts
AreaExtensions.simpleNodesOrder(area);
```

`simpleNodesOrder` змінює порядок елементів у DOM. Якщо вузли містять click-обробники й потрібен click-safe підхід, використовуйте альтернативу на основі z-index:
