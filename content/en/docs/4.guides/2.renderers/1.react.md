# React.js render
::alert
This guide is an extension of the [Basic](./basic) guide and provides in-depth instructions for using the `rete-react-render-plugin`
::
...
This plugin can be used in any application, regardless of your application stack (**React.js**, **Vue.js**, **Angular**).
