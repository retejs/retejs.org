...
This segregation means that Vue components rendered by Rete might not inherently share the Vue plugins or configurations applied in your project's main Vue app.
