...
As explained in the [Basic](/docs/basic#selectable-nodes) guide, you can enable node selection by using the `selectableNodes` extension
...
- [Comments](/docs/comments#selectable)
- [Reroute](/docs/reroute#selectable)
