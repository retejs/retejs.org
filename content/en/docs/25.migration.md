...
#right
The current version incorporates a revised approach that requires implementation, as demonstrated in [Import/export](./guides/import-export).
::
...
As a demonstration, we have opted to use a plugin created for the React render plugin
