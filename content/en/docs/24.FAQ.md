...
::questions
  ...
  ::qa{question="What are the steps to implement render plugin for other framework?" id="new-render-plugins"}
    ...
    - Use the source code of the following packages as a reference: [React.js](https://github.com/retejs/react-render-plugin), [Vue.js](https://github.com/retejs/vue-render-plugin), [Angular](https://github.com/retejs/angular-render-plugin) or [Svelte](https://github.com/retejs/svelte-render-plugin).
  ...
  ::qa{question="What if my app uses different stack and isn't based on React.js, Vue.js, or Angular?" id="different-stack"}
    In case you're using a framework other than React.js, Vue.js, Angular or Svelte (for which Rete.js provides a rendering plugin), you have the option to utilize the [React.js render plugin](/docs/guides/rendering/plugin) to render nodes and other editor elements.
