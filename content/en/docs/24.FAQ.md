...
::questions
  ...
  ::qa{question="What if my app uses different stack and isn't based on React.js, Vue.js, or Angular?" id="different-stack"}
    In case you're using a framework other than React.js, Vue.js or Angular (for which Rete.js provides a rendering plugin), you have the option to utilize the [React.js render plugin](/docs/guides/rendering/plugin) to render nodes and other editor elements.
