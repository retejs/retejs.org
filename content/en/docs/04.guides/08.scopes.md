...
Bu default, the plugin is set up to use its own node ordering. If you followed the [Basic](/docs/guides/basic) guide, you need to remove node ordering extensions such as `AreaExtensions.simpleNodesOrder` or `AreaExtensions.zIndexNodesOrder`.
